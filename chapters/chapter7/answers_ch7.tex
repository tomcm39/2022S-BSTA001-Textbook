...
\begin{enumerate}
    ...
    \begin{enumerate}
        \item {\color{red} Our estimate of $\sigma^2$ will shrink. This is because we estimate $\sigma^{2}$ as $\sum_{i=1}^{n} \epsilon_{i}^{2} / n$  }
    \end{enumerate}
    ...
    Please reexpress the estimated change in H1Ac in ounces of sugar consumed.  
     ...
     \begin{enumerate}
        \item {\color{red} 10 H1AC/lb * (1lb/16oz) = 10/16  }
    \end{enumerate} 
    
    \item Will different parameter estimates lead to different diagnostic plots? Why or why not?
    \begin{enumerate}
        \item {\color{red} Different parameter estimates will leaed to different diagnostic plots because different parameters will  will produce different fitted values and residuals.}
    \end{enumerate}
