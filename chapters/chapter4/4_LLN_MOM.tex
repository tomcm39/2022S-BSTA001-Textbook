...
\begin{align}
    P\left( -z_{1-\alpha/2} < \frac{\hat{\theta} - \theta}{ \frac{\sigma}{n}  } < z_{1-\alpha/2} \right) &= 1-\alpha \\ 
    P\left( -z_{1-\alpha/2} \frac{\sigma}{n} < \hat{\theta} - \theta < z_{1-\alpha/2} \frac{\sigma}{n} \right)&= 1-\alpha\\ 
    P\left( z_{1-\alpha/2} \frac{\sigma}{n} > \theta - \hat{\theta} > -z_{1-\alpha/2} \frac{\sigma}{n} \right) &= 1-\alpha\\ 
    P\left( \hat{\theta} + z_{1-\alpha/2} \frac{\sigma}{n} > \theta   > \hat{\theta} -z_{1-\alpha/2} \frac{\sigma}{n} \right)&= 1-\alpha \\ 
    P\left( \hat{\theta} - z_{1-\alpha/2} \frac{\sigma}{n} < \theta   < \hat{\theta} +z_{1-\alpha/2} \frac{\sigma}{n} \right) &= 1-\alpha\\
    P\left( \hat{\theta} - z_{1-\alpha/2} \frac{\hat{\sigma}}{n} < \theta   < \hat{\theta} +z_{1-\alpha/2} \frac{\hat{\sigma}}{n} \right) &= 1-\alpha
\end{align}
