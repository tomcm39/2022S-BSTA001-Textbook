...
\begin{enumerate}
   ...
   \begin{enumerate}
       ...
       \begin{enumerate}
           \item {\color{red} 
               \begin{align*}
                    P( no ILI \cap clin) &= P(No ILI | clin)P(clin)\\
                                     &= 0.8 (0.12) = 0.096
               \end{align*}}
        \end{enumerate}
       ...
       \begin{enumerate}
           \item {\color{red} 
               \begin{align*}
                    P( ILI \cap no clin) &= P(No ILI | clin)P(clin)\\
                                     &= 0.3 (0.88) = 0.264
               \end{align*}}
        \end{enumerate}
       ...
       \item Compute the probability a patient is not admitted to the hospital for ILI and they do not work in a clinical setting. (Looking for an equation and number)
        ...
        \begin{enumerate}
           \item {\color{red} 
               \begin{align*}
                    P( no ILI \cap no clin) &= P(No ILI | clin)P(clin)\\
                                     &= 0.7 (0.88) = 0.616
               \end{align*}}
        \end{enumerate}
       ...
       \begin{enumerate}
        \item {\color{red}
            \begin{align*}
                ...
                P(F | E) &= \frac{0.98 * 0.02  }{ 0.98*0.02+0.35*0.98 } \\ 
                &= \frac{0.0196}{0.3626  } \\ 
                &= 0.05\\
                \\
                P(F | C) &= \frac{0.50 * 0.02  }{ 0.5*0.02+0.15*0.98}
                &= \frac{0.01}{ 0.157 }\\
                &= 0.06
             \end{align*}
             
             Chills is most likely (if my math is correct)
        \end{enumerate}
